...
public class SumerianScene4 : MonoBehaviour
{
    ...
    void LoadDialogueIndex()
    {
        ...
        else
        {
            ...
            if (PlayerPrefs.HasKey("SumerianSceneFour_DialogueIndex"))
            {
                currentDialogueIndex = PlayerPrefs.GetInt("SumerianSceneFour_DialogueIndex");
    ...
    public void SaveAndLoad()
    {
        ...
        PlayerPrefs.SetInt("SumerianSceneFour_DialogueIndex", currentDialogueIndex);
        PlayerPrefs.SetString("LastScene", "SumerianSceneFour");
    ...
    void SaveCurrentProgress()
    {
        ...
        PlayerPrefs.SetInt("SumerianSceneFour_DialogueIndex", currentDialogueIndex);
        PlayerPrefs.SetString("CurrentScene", "SumerianSceneFour");
        PlayerPrefs.SetString("SaveTimestamp", System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
        PlayerPrefs.Save();
    }
