...
public class SumerianFirstRecallChallenges : MonoBehaviour
{
    ...
    void ShowDialogue()
    {
        ...
        if (audioSource != null)
        {
            if (dialogueLines == CuneiformLines && cuneiformClips != null && currentDialogueIndex < cuneiformClips.Length)
            {
                audioSource.clip = cuneiformClips[currentDialogueIndex];
                audioSource.Play();
            }
            else if (dialogueLines == baybayinLines && baybayinClips != null && currentDialogueIndex < baybayinClips.Length)
            {
                audioSource.clip = baybayinClips[currentDialogueIndex];
                audioSource.Play();
            }
            else if (dialogueLines == HieroglyphicsLines && hieroglyphicsClips != null && currentDialogueIndex < hieroglyphicsClips.Length)
            {
                audioSource.clip = hieroglyphicsClips[currentDialogueIndex];
                audioSource.Play();
            }
