...
public class KingdomScene4 : MonoBehaviour
{
    ...
    void ShowDialogue()
    {
        ...
        switch (currentDialogueIndex)
        {
            ...
            case 1:
                if (chronoAnimator != null)
                    chronoAnimator.Play("Ahmose - Determined", 0, 0f);
                if (playerAnimator != null)
                    playerAnimator.Play("Player_Curious", 0, 0f);
                break;
            case 2:
                if (chronoAnimator != null)
                    chronoAnimator.Play("Ahmose - Idle", 0, 0f);
                if (playerAnimator != null)
                    playerAnimator.Play("Player_Talking", 0, 0f);
                break;
            case 3:
                if (chronoAnimator != null)
                    chronoAnimator.Play("Ahmose - Fierce", 0, 0f);
                if (playerAnimator != null)
            ...
            case 5:
                if (chronoAnimator != null)
                    chronoAnimator.Play("Chrono_Smiling", 0, 0f);
                if (playerAnimator != null)
                    playerAnimator.Play("Player_Talking", 0, 0f);
                break;
            case 6:
