...
public class NileScene5 : MonoBehaviour
{
    [System.Serializable]
    ...
    void LoadDialogueIndex()
    {
        ...
        else if (StudentPrefs.HasKey("NileSceneFive_DialogueIndex"))
        {
            currentDialogueIndex = StudentPrefs.GetInt("NileSceneFive_DialogueIndex");
        }
        else
        {
            currentDialogueIndex = 0;
    ...
    void ShowNextDialogue()
    {
        ...
        if (currentDialogueIndex >= dialogueLines.Length)
        {
            SceneManager.LoadScene("NileQuizTime");
    ...
    {
        StudentPrefs.SetInt("NileSceneFive_DialogueIndex", currentDialogueIndex);
        StudentPrefs.SetString("LastScene", "NileSceneFive");
        ...
        if (SaveLoadManager.Instance != null)
            SaveLoadManager.Instance.SetCurrentGameState("NileSceneFive", currentDialogueIndex);
    ...
    {
        StudentPrefs.SetInt("NileSceneFive_DialogueIndex", currentDialogueIndex);
        StudentPrefs.SetString("CurrentScene", "NileSceneFive");
        StudentPrefs.SetString("SaveTimestamp", System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
        StudentPrefs.Save();
    }
    ...
    public void GoToSettings()
    {
        ...
        Debug.Log("Going to Settings from NileSceneFive");
