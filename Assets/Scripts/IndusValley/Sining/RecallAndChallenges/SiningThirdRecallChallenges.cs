...
public class SiningThirdRecallChallenges : MonoBehaviour
{
    [System.Serializable]
            ...
            switch (currentDialogueIndex)
            {
                case 0:
                    ...
                    if (!challengeCompleted)
                    {
                        ...
                        {
                            SaveLoadManager.Instance.OverwriteAllSavesAfterChallenge("SiningSceneFive", 0);
                        }
                    }
    ...
    void LoadNextScene()
    {
        SceneManager.LoadScene("SiningSceneFive");
    }
}