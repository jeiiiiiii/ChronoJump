...
public class SiningScene4 : MonoBehaviour
{
    [System.Serializable]
    ...
    void LoadDialogueIndex()
    {
        ...
        {
            if (StudentPrefs.HasKey("SiningSceneFour_DialogueIndex"))
            {
                currentDialogueIndex = StudentPrefs.GetInt("SiningSceneFour_DialogueIndex");
    ...
    void ShowNextDialogue()
    {
        ...
        if (currentDialogueIndex >= dialogueLines.Length)
        {
            SceneManager.LoadScene("SiningThirdRecallChallenges");
    ...
    {
        StudentPrefs.SetInt("SiningSceneFour_DialogueIndex", currentDialogueIndex);
        StudentPrefs.SetString("LastScene", "SiningSceneFour");
        ...
        if (SaveLoadManager.Instance != null)
            SaveLoadManager.Instance.SetCurrentGameState("SiningSceneFour", currentDialogueIndex);
    ...
    {
        StudentPrefs.SetInt("SiningSceneFour_DialogueIndex", currentDialogueIndex);
        StudentPrefs.SetString("CurrentScene", "SiningSceneFour");
        StudentPrefs.SetString("SaveTimestamp", System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
        StudentPrefs.Save();
    }
    ...
    public void GoToSettings()
    {
        ...
        Debug.Log("Going to Settings from SiningSceneFour");
