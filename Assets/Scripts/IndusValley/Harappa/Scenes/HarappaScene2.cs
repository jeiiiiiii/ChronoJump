...
public class HarappaScene2 : MonoBehaviour
{
    [System.Serializable]
    ...
    void LoadDialogueIndex()
    {
        ...
        {
            if (StudentPrefs.HasKey("HarappaSceneTwo_DialogueIndex"))
            {
                currentDialogueIndex = StudentPrefs.GetInt("HarappaSceneTwo_DialogueIndex");
    ...
    void ShowNextDialogue()
    {
        ...
        if (currentDialogueIndex >= dialogueLines.Length)
        {
            SceneManager.LoadScene("HarappaSecondRecallChallenges");
    ...
    {
        StudentPrefs.SetInt("HarappaSceneTwo_DialogueIndex", currentDialogueIndex);
        StudentPrefs.SetString("LastScene", "HarappaSceneTwo");
        ...
        if (SaveLoadManager.Instance != null)
            SaveLoadManager.Instance.SetCurrentGameState("HarappaSceneTwo", currentDialogueIndex);
    ...
    {
        StudentPrefs.SetInt("HarappaSceneTwo_DialogueIndex", currentDialogueIndex);
        StudentPrefs.SetString("CurrentScene", "HarappaSceneTwo");
        StudentPrefs.SetString("SaveTimestamp", System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
        StudentPrefs.Save();
    }
    ...
    public void GoToSettings()
    {
        ...
        Debug.Log("Going to Settings from HarappaSceneTwo");
