...
public class AkkadianScene3 : MonoBehaviour
{
    ...
    void ShowDialogue()
    {
        ...
        SargoncharacterRenderer.sprite = null;

        switch (currentDialogueIndex)
        {
            case 0: 
                SargoncharacterRenderer.sprite = SargonWise;
            ...
            case 2: 
                SargoncharacterRenderer.sprite = SargonExplaining;
                PlayercharacterRenderer.sprite = PlayerCurious;
                break;
