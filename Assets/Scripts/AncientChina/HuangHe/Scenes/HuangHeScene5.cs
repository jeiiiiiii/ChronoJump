...
public class HuangHeScene5 : MonoBehaviour
{
    [System.Serializable]
    ...
    void LoadDialogueIndex()
    {
        ...
        else if (StudentPrefs.HasKey("HuangHeSceneFive_DialogueIndex"))
        {
            currentDialogueIndex = StudentPrefs.GetInt("HuangHeSceneFive_DialogueIndex");
        }
        else
        {
            currentDialogueIndex = 0;
    ...
    void ShowNextDialogue()
    {
        ...
        if (currentDialogueIndex >= dialogueLines.Length)
        {
            SceneManager.LoadScene("HuangHeQuizTime");
    ...
    {
        StudentPrefs.SetInt("HuangHeSceneFive_DialogueIndex", currentDialogueIndex);
        StudentPrefs.SetString("LastScene", "HuangHeSceneFive");
        ...
        if (SaveLoadManager.Instance != null)
            SaveLoadManager.Instance.SetCurrentGameState("HuangHeSceneFive", currentDialogueIndex);
    ...
    {
        StudentPrefs.SetInt("HuangHeSceneFive_DialogueIndex", currentDialogueIndex);
        StudentPrefs.SetString("CurrentScene", "HuangHeSceneFive");
        StudentPrefs.SetString("SaveTimestamp", System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
        StudentPrefs.Save();
    }
    ...
    public void GoToSettings()
    {
        ...
        Debug.Log("Going to Settings from HuangHeSceneFive");
