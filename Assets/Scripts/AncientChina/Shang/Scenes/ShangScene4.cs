...
public class ShangScene4 : MonoBehaviour
{
    [System.Serializable]
    ...
    void LoadDialogueIndex()
    {
        ...
        {
            if (StudentPrefs.HasKey("ShangSceneFour_DialogueIndex"))
            {
                currentDialogueIndex = StudentPrefs.GetInt("ShangSceneFour_DialogueIndex");
    ...
    void ShowDialogue()
    {
        ...
        switch (currentDialogueIndex)
        {
            ...
            case 1:
                if (chronoAnimator != null)
                    chronoAnimator.Play("Wu Ding_Worried", 0, 0f);
                if (playerAnimator != null)
            ...
            case 3:
                if (chronoAnimator != null)
                    chronoAnimator.Play("Fu Hao_Fierce", 0, 0f);
                if (playerAnimator != null)
                    playerAnimator.Play("Player_Reflective", 0, 0f);
                break;
            case 4:
    ...
    void ShowNextDialogue()
    {
        ...
        if (currentDialogueIndex >= dialogueLines.Length)
        {
            SceneManager.LoadScene("ShangThirdRecallChallenges");
    ...
    {
        StudentPrefs.SetInt("ShangSceneFour_DialogueIndex", currentDialogueIndex);
        StudentPrefs.SetString("LastScene", "ShangSceneFour");
        ...
        if (SaveLoadManager.Instance != null)
            SaveLoadManager.Instance.SetCurrentGameState("ShangSceneFour", currentDialogueIndex);
    ...
    {
        StudentPrefs.SetInt("ShangSceneFour_DialogueIndex", currentDialogueIndex);
        StudentPrefs.SetString("CurrentScene", "ShangSceneFour");
        StudentPrefs.SetString("SaveTimestamp", System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
        StudentPrefs.Save();
    }
    ...
    public void GoToSettings()
    {
        ...
        Debug.Log("Going to Settings from ShangSceneFour");
