...
public class ShangScene5 : MonoBehaviour
{
    [System.Serializable]
    ...
    void LoadDialogueIndex()
    {
        ...
        else if (StudentPrefs.HasKey("ShangSceneFive_DialogueIndex"))
        {
            currentDialogueIndex = StudentPrefs.GetInt("ShangSceneFive_DialogueIndex");
        }
        else
        {
            currentDialogueIndex = 0;
    ...
    void ShowNextDialogue()
    {
        ...
        if (currentDialogueIndex >= dialogueLines.Length)
        {
            SceneManager.LoadScene("ShangQuizTime");
    ...
    {
        StudentPrefs.SetInt("ShangSceneFive_DialogueIndex", currentDialogueIndex);
        StudentPrefs.SetString("LastScene", "ShangSceneFive");
        ...
        if (SaveLoadManager.Instance != null)
            SaveLoadManager.Instance.SetCurrentGameState("ShangSceneFive", currentDialogueIndex);
    ...
    {
        StudentPrefs.SetInt("ShangSceneFive_DialogueIndex", currentDialogueIndex);
        StudentPrefs.SetString("CurrentScene", "ShangSceneFive");
        StudentPrefs.SetString("SaveTimestamp", System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
        StudentPrefs.Save();
    }
    ...
    public void GoToSettings()
    {
        ...
        Debug.Log("Going to Settings from ShangSceneFive");
