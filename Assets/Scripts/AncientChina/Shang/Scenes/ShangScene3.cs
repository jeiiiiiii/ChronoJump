...
public class ShangScene3 : MonoBehaviour
{
    [System.Serializable]
    ...
    void LoadDialogueIndex()
    {
        ...
        {
            if (StudentPrefs.HasKey("ShangSceneThree_DialogueIndex"))
            {
                currentDialogueIndex = StudentPrefs.GetInt("ShangSceneThree_DialogueIndex");
    ...
    void ShowNextDialogue()
    {
        ...
        if (currentDialogueIndex >= dialogueLines.Length)
        {
            SceneManager.LoadScene("ShangSceneFour");
    ...
    {
        StudentPrefs.SetInt("ShangSceneThree_DialogueIndex", currentDialogueIndex);
        StudentPrefs.SetString("LastScene", "ShangSceneThree");
        ...
        if (SaveLoadManager.Instance != null)
            SaveLoadManager.Instance.SetCurrentGameState("ShangSceneThree", currentDialogueIndex);
    ...
    {
        StudentPrefs.SetInt("ShangSceneThree_DialogueIndex", currentDialogueIndex);
        StudentPrefs.SetString("CurrentScene", "ShangSceneThree");
        StudentPrefs.SetString("SaveTimestamp", System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
        StudentPrefs.Save();
    }
    ...
    public void GoToSettings()
    {
        ...
        Debug.Log("Going to Settings from ShangSceneThree");
